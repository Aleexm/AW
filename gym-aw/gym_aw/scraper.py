'''
================================
Script used to get AWBW assets
================================
'''
...
def gif_to_jpg(pathname):
    "AWBW has gifs, convert to jpgs"
    for file in os.listdir(pathname):
        old_name = os.path.join(pathname, file)
        new_name = os.path.join(pathname, file[:-3] + 'jpg')
